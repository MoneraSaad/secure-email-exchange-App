		...
		//s boxes values in hex
		 String sBoxes[][] 
			    ...
			    { 
			     ...
			     Blowfish() throws FileNotFoundException 
			    { 
			      ...
			      //  String plainText = "123456abcd132536"; 
					...
					try {
						String key = RSAKeyGeneration.generateKey();
						 keyGenerate(key); 
			        ...
			        //new input file 
			        File inputFile= new File("C:\\Users\\User\\eclipse-workspace\\Cryptology_RSA_Blowfish_ELGamal\\src\\myPackage\\input.txt");
